...
if(isset($_POST['botonGuardarEditarFoto'])){
	...
	if($actualizada){
		...
		echo "<script type='text/javascript'>location.href='".RUTA_VER_TODAS_LAS_FOTOS."';</script>";
		die();
	}else{
...
<div class="container">
	...
	<div class="row">
		<div class="col-md-4">
			<form method="POST" id='formularioVerFoto' name='formularioVerFoto' action="<?php echo RUTA_EDITAR_FOTO; ?>" enctype="multipart/form-data">
