	<form class='form-horizontal' name="registerform" id="registerform" method="post" action="<?php echo RUTA_REGISTRO; ?>">
		<div class='form-group'>
			<!-- sr-only solo sirve para que los videntes consigan escuchar como un ordenador le lee el código-->
			...
			<div class='col-md-6'>
				...
				<input type="text" class="form-control" name="nombreusuario" id="nombreusuario" title='El nombre debe de contener entre 4 y 15 letras o números sin espacios' placeholder="Nombre:">
			</div>
		...
		<div class='form-group'>
			...
			<div class='col-md-6'>
				<!--Este input tiene la validación HTML (required, pattern y title),  javascript y PHP-->
